...
public class Clade {
	...
	/**
	 * The number of times times this clade occurs in the processed set of
	 * trees.
	 */
	 ...
	 * 
	 * @param cladeInBits
	 *            BitSet representation of the clade
	 * @param abstractCCD
	 *            CCD this clade is part of
	 */
	 ...
	 * 
	 * @param targetCCD
	 *            CCD to which the copy will belong to
	 ...
	 * 
	 * @param firstChildClade
	 *            one of the two child clades forming the bipartition
	 * @param secondChildClade
	 *            other of the two child clades forming the bipartition
	 ...
	 * 
	 * @param firstChildClade
	 *            one of the two child clades partitioning this clade
	 * @param secondChildClade
	 *            other of the two child clades partitioning this clade
	 ...
	 *            other of the two child clades partitioning this clade
	 * @param storeParent
	 *            whether to store this clade as parent clade in the child
	 *            clades
	 * @return a new clade partition based on the two given child clades
	 */
	public CladePartition createCladePartition(Clade firstChildClade, Clade secondChildClade,
	 ...
	 * 
	 * @param numAdditionalOccurrences
	 *            to be registered
	 */
	 ...
	 * 
	 * @param height
	 *            at which clade occurred (but record gets now discarded)
	 */
	...
	/**
	 * @param value
	 *            sum of subtree clade credibilities of all subtrees rooted at
	 *            this clade
	 */
	 ...
	 * proper) subclade.
	 * 
	 * @param potentialSubclade
	 *            to be tested if contained in this clade
	 ...
	 * 
	 * @param filter
	 *            to be tested if contains this clade
	 ...
	 * 
	 * @param potentialIntersectedClade
	 *            to be tested if intersects with this clade
	 ...
	 * 
	 * @param filter
	 *            to be tested if equals with this clade
	...
	/**
	 * @param baseClade
	 *            set as base clade of this clade (when clade comes from
	 *            filtering)
	 */
