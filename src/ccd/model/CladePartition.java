...
public class CladePartition {
	 ...
	 * 
	 * @param parentClade
	 *            the parent clade that gets partition
	 * @param childClades
	 *            the at least two child clades that partition the parent clade
	 */
	 ...
	 * 
	 * @param height
	 *            at which partition occurred (but record gets now discarded)
	 */
	 ...
	 *            the new total number of occurrences
	 */
	...
	public String toString() {
		return "CladePartition [numOccurrences=" + numOccurrences + ", meanHeight=" + meanHeight
				+ ", numTopologies=" + numTopologies + ", childClades="
				+ Arrays.toString(childClades) + "]";
	}
	 ...
	 * 
	 * @param childClade
	 *            clade that is child of this partition with its sibling wanted
	 ...
	 * 
	 * @param cladeToTest
	 *            for which is checked whether it is one of the partitioning
	 ...
	 *            clade partition to compare it to
	...
	public double getCCP() {
		...
		// if (this.ccp < 0) {
		// ccp = ((double) this.numOccurrences)
		// / ((double) this.getParentClade().getNumOccurrences());
		// }
		//
		// return ccp;
	}
